...
In the [last post](/2026/06/can-ai-build-an-app-autonomously.html), I built a little task runner called **Autodev** and had it write an Android App. It worked — Claude shipped a real Android app to the Play Store. The experiment put autodev to run the same work for different models. None of them completed the work, except Gemma 4 32B running locally on a RTX 3090 TI. I rapidly found out that it was cheating. No app was built. It just made up tests that would make the tests pass without verifying anything.
